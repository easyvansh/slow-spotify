...
function Search({search,setSearch}) {
    ...
    return (
        <div className=" max-w-[1400px] bg-[#1a1a1a] rounded-full overflow-hidden border-2 border-[#333333] p-1.5 px-5 pr-8 flex items-center">
            <div className=" h-6 w-6 rounded-full border-2 flex-shrink-0 animate-pulse"/>
            <input 
            type="text"
            value= {search}
        ...
        <div className="flex items-center divide-dotted divide-x-2 divide-[#333] ml-auto">
            ...
            <div className= "flex items-center space-x-1.5 text-[#cecece] pl-4">
                ...
                <span classnames=" font-medium text-small">Filters</span>
            </div>
        </div>
